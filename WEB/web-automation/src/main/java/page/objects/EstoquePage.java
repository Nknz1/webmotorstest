...
public class EstoquePage extends AbstractPageObject {

	public static EstoquePage Action() {
	...
	@FindBy(xpath = "//*[@id=\"root\"]/main/div[1]/div[4]/div[2]/div/div/div/div/div/div[1]/div/div[1]/a[2]")
	public WebElement firstCarStoque;
	
	@FindBy(id = "VehicleSellerInformationStock")
	public WebElement buttonVerTodosVeiculos;
